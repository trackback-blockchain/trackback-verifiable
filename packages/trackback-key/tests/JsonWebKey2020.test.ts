...
describe('sign test', () => {
  it('sign deattached', async () => {
    ...
    const sig = 'NmVavyXt43T8eW3ISS4J0Z18jBmlzK8OwYMrjBTWrEZlrB3a5MDrcBeIeppheRgV_4BGys-IlpByxnNLPJsXDQ';
  ...
  it('sign', async () => {
    ...
    const sig = '8QKNsPEfCx35RmbHz39RchXCdRoOH9BVA1o-4yTdy6wO0co65DE5zMO0m-sIhYmAlQEY8UYrHvM6tUXAaTG6Cg';
