...
import { ExtrinsicResults, toUint8Array, transformParams, uriToHex } from "./helpers";

export interface IProcedure {
    resolve(didUri: string): Promise<IDIDResolutionResult>;
    constructDIDDocument(
        account: IKeyringPair, didDocument: DIDDocument, didDocumentMetadata: IDIDDocumentMetadata,
