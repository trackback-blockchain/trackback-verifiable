...
describe('Presentation Tests', () => {
    describe('Check presentation Tests', () => {
        ...
        describe('Presentation must validate credentials', () => {
            ...
            it('validate credential @context', () => {
                ...
                expect(() => vp.validate(presentation)).to.throw(Error, 'Credentials must have a "@context" property');
            });
            ...
            it('Credentials first item is a URI: https://www.w3.org/2018/credentials/v1', () => {
                ...
                expect(() => vp.validate(presentation)).to.throw(Error, 'Credentials first item is a URI with the value https://www.w3.org/2018/credentials/v1');
            });
            ...
            it('Credentials should have a type attribute', () => {
                ...
                expect(() => vp.validate(presentation)).to.throw(Error, 'Credentials must have "type"');
            });
            ...
            it('Credentials should have a type (array) attribute ', () => {
                ...
                expect(() => vp.validate(presentation)
                ).to.throw(Error, 'Credentials must have "type"');
            });
            ...
            it('Credentials should have a type credentialSubject ', () => {
                ...
                expect(() => vp.validate(presentation)).to.throw(Error, 'Credentials must have "credentialSubject"');
            });
            ...
            it('Credentials should have a type issuer ', () => {
                ...
                expect(() => vp.validate(presentation)).to.throw(Error, 'Credentials must have "issuer"');
            });
    ...
    describe('VP Tests for issue and verify JWT', () => {
        ...
        it('should create a valid jwt ', async () => {
            ...
            expect(JSON.stringify(payload.vp)).to.be.equal(JSON.stringify(presentation))
